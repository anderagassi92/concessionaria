...
<body>
    ...
    <div class="div-button">
        <a href="cadastro_marca.php"><button>Novo</button></a>
    </div>
    <table cellspacing="0">
        <thead>
            <tr>
                ...
                foreach($resultset as $row){                
                    echo '
                        <tr>
                            ...
                            <td>'.$row['nome'].'</td>
                            <td class="text-left">
                                <a href="cadastro_marca.php?id='.$row['id'].'">Editar</a>
                            </td>
                            <td class="text-left">
                                <a href="crud_salvar_marca.php?opcao=excluir&id='.$row['id'].'">Excluir</a>
                            </td>
                        </tr>
                    ';
                }
